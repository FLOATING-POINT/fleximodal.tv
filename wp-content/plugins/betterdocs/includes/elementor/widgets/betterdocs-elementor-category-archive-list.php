    ...
    public function subcat_list_settings()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .docs-category-listing .docs-list ul li ul.docs-sub-cat li a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'normal',
                'selectors' => [
                    '{{WRAPPER}} .docs-category-listing .docs-list ul li ul.docs-sub-cat li a' => 'word-wrap: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .docs-category-listing .docs-list ul li ul.docs-sub-cat li a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .docs-category-listing .docs-list ul li ul.docs-sub-cat li a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .docs-category-listing .docs-list ul li ul.docs-sub-cat li' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .docs-category-listing .docs-list ul li ul.docs-sub-cat li svg' => 'fill: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    '{{WRAPPER}} .docs-category-listing .docs-list ul li ul.docs-sub-cat li svg' => 'font-size: {{SIZE}}{{UNIT}};'
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .docs-category-listing .docs-list ul li ul.docs-sub-cat li svg' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
