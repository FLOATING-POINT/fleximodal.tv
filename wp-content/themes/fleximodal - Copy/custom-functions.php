...
function setup(){
 ...
 /* javascript */
  ...
  if(is_page_template( 'templates/template-tv.php' ) || is_page_template( 'templates/template-channels.php' )){
    wp_enqueue_style( 'style', get_template_directory_uri() . '/assets/css/style.css', array('reset'), '1.0', 'screen, projection' );
    wp_enqueue_style( 'style-tv', get_template_directory_uri() . '/assets/css-custom/style-tv.css', array('reset','style'), '1.0', 'screen, projection' );
    wp_enqueue_style( 'style-ticker', get_template_directory_uri() . '/assets/css-custom/ticker.css', array('reset','style'), '1.0', 'screen, projection' );
